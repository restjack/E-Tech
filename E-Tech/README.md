...
| Factorissimo map icons | off | Needs [Factorissimo (notnotmelon fork)](https://mods.factorio.com/mod/factorissimo-2-notnotmelon). Mirrors each factory building's first overlay signal as a map marker — factories become identifiable in map view like machines' recipe icons |
